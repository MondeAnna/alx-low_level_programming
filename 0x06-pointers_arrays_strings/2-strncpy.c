...
/**
 * test_strncpy_len_greater_than_src - copy greater chars than src has
 *
 * Return: void
 */
...
/**
 * test_strncpy_len_less_than_src - copy fewer chars than src has
 *
 * Return: void
 */
void test_strncpy_len_less_than_src(void)
{
	...
	char *expected = "At the beginning...Man made Machine";
	char dest[100] = "In the beginning...Man made Machine";
	char *src = "At the very END!";
	char *copy;

	copy = _strncpy(dest, src, 2);
